...
INSERT INTO `class_members` VALUES (1,1,1,'teacher','2025-10-14 14:07:41'),(2,1,2,'student','2025-10-14 14:07:41'),(3,2,1,'teacher','2025-10-14 16:11:11'),(4,2,2,'student','2025-10-14 16:12:12'),(7,3,1,'teacher','2025-10-20 09:43:20');
...
INSERT INTO `classes` VALUES (1,'Database Systems','DBMS TH','BCSE302L',1,'2025-10-14 14:07:41'),(2,'Database Systems Lab','DBMS LO','BCSE302P',1,'2025-10-14 16:11:11'),(3,'DBMS Advanced','Advanced DBMS','BCSE302AD',1,'2025-10-20 09:43:20');
...
INSERT INTO `message_reads` VALUES (1,1,1,'2025-10-20 09:44:38'),(2,1,2,'2025-10-18 16:27:53'),(3,2,2,'2025-10-19 05:37:50');
...
--
-- Final view structure for view `vw_assignments`
--
...
/*!50001 VIEW `vw_assignments` AS select `a`.`id` AS `id`,`a`.`class_id` AS `class_id`,`a`.`title` AS `title`,`a`.`description` AS `description`,`a`.`due_date` AS `due_date`,`a`.`total_points` AS `total_points`,`a`.`created_at` AS `created_at`,`c`.`title` AS `class_title`,`c`.`code` AS `class_code` from (`assignments` `a` join `classes` `c` on((`c`.`id` = `a`.`class_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_classes`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_classes` AS select `c`.`id` AS `id`,`c`.`title` AS `title`,`c`.`description` AS `description`,`c`.`code` AS `code`,`c`.`teacher_id` AS `teacher_id`,`c`.`created_at` AS `created_at`,`u`.`name` AS `teacher_name`,`u`.`email` AS `teacher_email`,(select count(0) from `class_members` `m` where (`m`.`class_id` = `c`.`id`)) AS `member_count` from (`classes` `c` join `users` `u` on((`u`.`id` = `c`.`teacher_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_submissions`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_submissions` AS select `s`.`id` AS `id`,`s`.`assignment_id` AS `assignment_id`,`s`.`student_id` AS `student_id`,`s`.`submitted_at` AS `submitted_at`,`s`.`content` AS `content`,`s`.`file_path` AS `file_path`,`s`.`grade` AS `grade`,`s`.`feedback` AS `feedback`,`u`.`name` AS `student_name`,`u`.`email` AS `student_email`,`c`.`teacher_id` AS `teacher_id` from (((`submissions` `s` join `users` `u` on((`u`.`id` = `s`.`student_id`))) join `assignments` `a` on((`a`.`id` = `s`.`assignment_id`))) join `classes` `c` on((`c`.`id` = `a`.`class_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-10-20 16:09:08
